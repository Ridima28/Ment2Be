...
const LandingFooter = () => {
  return (
    ...
    >
          ...
          <h4 className="text-slate-900 text-center p-4 text-2xl mt-5 dark:text-white font-semibold mb-4">
            Connect With Us
          </h4>
...
<div className="border-t border-slate-200 mt-7 dark:border-gray-800 pt-8">
